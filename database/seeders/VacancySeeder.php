...
class VacancySeeder extends Seeder
{
    ...
    public function run(): void
    {
        $jobs = [
            ...
            [
                'id' => 108,
                'title' => 'Avionics Technician Specialist',
                'department' => 'Institute of Computer Studies & Aviation Information Systems',
                'employment_type' => 'Full-time',
                'location' => 'Villamor Air Base, Pasay City',
                'salary_grade' => 11,
                'description' => 'Maintains, tests, and calibrates aircraft communication, navigation, and radar systems for laboratory training aircraft fleet.',
                'responsibilities' => [
                    'Perform scheduled maintenance on aircraft radio navigation and radar systems.',
                    'Assist instructors during avionics laboratory practical sessions.',
                    'Calibrate electrical test equipment and diagnose wiring harness faults.',
                    'Maintain logbooks of avionics equipment repairs and upgrades.',
                ],
                'requirements' => [
                    [
                        'id' => 'req_edu_8',
                        'category' => 'Education',
                        'title' => 'BS in Avionics Technology or Aviation Electronics Engineering',
                        'is_mandatory' => true,
                        'keywords' => ['BS Avionics Technology', 'Avionics Engineering', 'Electronics'],
                    ],
                    [
                        'id' => 'req_elig_8',
                        'category' => 'Eligibility',
                        'title' => 'CAAP Aircraft Maintenance License (AMT/AMS - Avionics)',
                        'is_mandatory' => true,
                        'keywords' => ['CAAP License', 'Avionics License', 'AMS License'],
                    ],
                    [
                        'id' => 'req_exp_8',
                        'category' => 'Experience',
                        'title' => '1 year of relevant experience in avionics repair',
                        'is_mandatory' => false,
                        'keywords' => ['1 year experience', 'Avionics Repair'],
                    ],
                    [
                        'id' => 'req_trn_8',
                        'category' => 'Training',
                        'title' => '4 hours of avionics systems training',
                        'is_mandatory' => false,
                        'keywords' => ['Avionics Training'],
                    ],
                ],
                'deadline' => now()->addDays(30),
                'status' => 'Open',
            ...
            [
                'id' => 109,
                'title' => 'Aircraft Maintenance Technology Instructor',
                'department' => 'Institute of Engineering & Aviation Technology',
                'employment_type' => 'Full-time',
                'location' => 'Villamor Air Base, Pasay City',
                'salary_grade' => 13,
                'description' => 'Teaches practical aircraft airframe and powerplant courses, supervises hangar training, and prepares students for CAAP licensing exams.',
                'responsibilities' => [
                    'Conduct lectures and hangar workshops on reciprocating engines and airframe structures.',
                    'Ensure student compliance with workshop safety and aviation regulations.',
                    'Evaluate student practical proficiency in sheet metal and powerplant overhaul.',
                    'Assist in maintaining hangar tools and instructional aircraft.',
                ],
                'requirements' => [
                    [
                        'id' => 'req_edu_9',
                        'category' => 'Education',
                        'title' => 'BS in Aircraft Maintenance Technology (BSAMT)',
                        'is_mandatory' => true,
                        'keywords' => ['BS Aircraft Maintenance Technology', 'BSAMT'],
                    ],
                    [
                        'id' => 'req_elig_9',
                        'category' => 'Eligibility',
                        'title' => 'CAAP Airframe & Powerplant (A&P) Maintenance License',
                        'is_mandatory' => true,
                        'keywords' => ['CAAP AMT License', 'A&P License', 'Airframe Powerplant'],
                    ],
                    [
                        'id' => 'req_exp_9',
                        'category' => 'Experience',
                        'title' => '1 year of aircraft maintenance hangar experience',
                        'is_mandatory' => true,
                        'keywords' => ['Hangar Experience', '1 year maintenance'],
                    ],
                ],
                'deadline' => now()->addDays(30),
                'status' => 'Open',
            ...
            [
                ...
                'department' => 'Student Affairs & Guidance Office',
                'employment_type' => 'Full-time',
                'location' => 'Villamor Air Base, Pasay City',
                'salary_grade' => 12,
                'description' => 'Provides psychological counseling, career guidance, and student mental health support services across aviation academic departments.',
                'responsibilities' => [
                    'Conduct individual and group counseling sessions for aviation students.',
                    'Administer psychological tests and entrance guidance assessments.',
                    'Organize career counseling seminars and mental health awareness programs.',
                    'Maintain confidential student guidance records per Republic Act 11036.',
                ],
                'requirements' => [
                    [
                        'id' => 'req_edu_10',
                        'category' => 'Education',
                        'title' => 'Master\'s Degree in Guidance & Counseling or Psychology',
                        'is_mandatory' => true,
                        'keywords' => ['Master in Guidance and Counseling', 'MA Psychology', 'Master\'s Degree'],
                    ],
                    [
                        'id' => 'req_elig_10',
                        'category' => 'Eligibility',
                        'title' => 'RA 1080 (Registered Guidance Counselor)',
                        'is_mandatory' => true,
                        'keywords' => ['RA 1080', 'Registered Guidance Counselor', 'PRC Counselor License'],
                    ],
                    [
                        'id' => 'req_exp_10',
                        'category' => 'Experience',
